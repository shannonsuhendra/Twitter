...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "2seVINWMj3bpyvNWN2H3oeXoF", consumerSecret: "GqEdHZ1F5uNmvWJuBJYtBFvSzML5PwF0PVT6PPEzdPOIakLjeI")
    var loginSuccess: (() -> ())?
